...
const UserBookings = () => {
  ...
  const fetchBookings = async () => {
    try {
      ...
      const response = await fetch(`${API_URL}/get-user-bookings.php?${queryParams}`);
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 text-center">
              ...
              <p className="lead">View and manage your property bookings</p>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="col-12">
              ...
              {bookings.length === 0 ? (
                <div className="text-center py-5">
                  ...
                  <p className="text-muted">You haven't made any property bookings yet.</p>
